...
//       Bread breadTotal = new Bread(bread);
//       Pastry pastryOrder = new Pastry(pastry);

//       Console.WriteLine($"Merveilleux! your order was for {bread} loaves of bread and {pastry} delectable pastries. Your total will be ${breadTotal.OrderAmount() + pastryOrder.OrderAmount()}.");
